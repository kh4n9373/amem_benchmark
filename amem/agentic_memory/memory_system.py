...
class AgenticMemorySystem:
    ...
    def __init__(self, 
        ...
        Args:
            ...
            base_url: Base URL for LLM API (for custom endpoints like local LLMs)
            disable_thinking: Disable thinking for Qwen models
        """
        self.memories = {}
        ...
        # Initialize LLM controller with base_url and disable_thinking
        self.llm_controller = LLMController(llm_backend, llm_model, api_key, base_url, disable_thinking)
        self.evo_cnt = 0
